...
{{< figure src="static/img/posts/obstacle-tower-challenge/obstacle-environment.png" title="Figure 1: Examples of agent observations in the Obstacle Tower at different floor levels. [Left] Early floor is rendered in the Ancient theme.
[Middle] Intermediate floor is rendered using the Moorish theme. [Right] Later floor is rendered in Industrial theme." >}}
